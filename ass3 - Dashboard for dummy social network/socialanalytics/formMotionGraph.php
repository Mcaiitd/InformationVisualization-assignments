<?php
echo("Choose among the following top 10 topics of the last week");
...
<?php for($i=1;$i<=10;$i++) : ?>  <?php echo $top10list[$i] ?>: <input type="radio" name="topic" value="<?php echo $top10list[$i] ?>" /><br/><?php endfor; ?>
 <br/>
