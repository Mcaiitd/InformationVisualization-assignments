...
<div id="logo">
	<font size="7" face="fantasy"><a href="file:///C:/Users/harvineet%20singh/Desktop/csp301/socialnetwork/class2.htm">Social network analytics</a></font>
</div>
<br>
<!-- end header -->
...
<div id="container2" style="width:100%">
	<div class="leftCol" style="width:50%; background:Azure; float:left">
		<iframe src="Form.php" width="900" height="600"></iframe>
	</div>
...
<div class="mtitle" style="width:100%; clear:both; background:RoyalBlue; height:35px">
	<h1> Motion chart for topic activity in clusters </h1>
</div>
<div class="mgraph" style="width:100%; background:Azure">
	<iframe src="formMotionGraph.php" width="950" height="400"></iframe>
</div>
